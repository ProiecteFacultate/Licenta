...
void initializeFAT32(char* hardDiskPath, DiskInfo** diskInfo, BootSector** bootSector, FsInfo** fsInfo, uint32_t sectorsNumber, uint32_t sectorSize)
{
    ...
    *fsInfo = nullptr;
    ...
    fat32Startup(hardDiskPath, diskInfo, bootSector, fsInfo, sectorsNumber, sectorSize);
}
...
{
    *diskInfo = nullptr;
    ext2Startup(hardDiskPath, diskInfo, sectorsNumber, sectorSize);
...
{
    *diskInfo = nullptr;
    hfsStartup(hardDiskPath, diskInfo, sectorsNumber, sectorSize);
