...
#define SEARCH_MULTIPLE_DATA_BLOCKS_IN_GROUP_SUCCESS                                                   999
...
#define SEARCH_FIRST_EMPTY_INODE_IN_GROUP_SUCCESS                                                      999

#define UPDATE_GROUP_DESCRIPTOR_FAILED                                                                 0
#define UPDATE_GROUP_DESCRIPTOR_SUCCESS                                                                999

#define UPDATE_VALUE_IN_INODE_BITMAP_FAILED                                                            0
#define UPDATE_VALUE_IN_INODE_BITMAP_SUCCESS                                                           999

#define UPDATE_VALUE_IN_DATA_BLOCK_BITMAP_FAILED                                                       0
#define UPDATE_VALUE_IN_DATA_BLOCK_BITMAP_SUCCESS                                                      999

#define ADD_INODE_TO_INODE_TABLE_FAILED                                                                0
#define ADD_INODE_TO_INODE_TABLE_SUCCESS                                                               999

#define ADD_DIRECTORY_ENTRY_TO_PARENT_FAILED                                                           0
#define ADD_DIRECTORY_ENTRY_TO_PARENT_SUCCESS                                                          999

#define UPDATE_INODE_FAILED                                                                            0
#define UPDATE_INODE_SUCCESS                                                                           999
...
#define FREE_ALL_DIRECTORY_AND_CHILDREN_BLOCKS_SUCCESS                                                 999

#define DELETE_INODE_FAILED                                                                            0
#define DELETE_INODE_SUCCESS                                                                           999

#define DELETE_DIRECTORY_ENTRY_FROM_PARENT_FAILED                                                      0
#define DELETE_DIRECTORY_ENTRY_FROM_PARENT_SUCCESS                                                     999

#define DELETE_ALL_DIRECTORY_AND_CHILDREN_INODES_FAILED                                                0
#define DELETE_ALL_DIRECTORY_AND_CHILDREN_INODES_SUCCESS                                               999

#define SEARCH_DIRECTORY_ENTRY_BY_INODE_AND_PARENT_INODE_FAILED                                        0
#define SEARCH_DIRECTORY_ENTRY_BY_INODE_AND_PARENT_INODE_SUCCESS                                       999
